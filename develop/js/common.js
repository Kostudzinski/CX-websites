  ...
  if($("#expandedImg").length) {
    ...
    $('#parameters li').on('mouseover',function () {
      li_image_src = $(this).find(".li_image").attr('src');
	    $('#expandedImg').fadeOut(100);
	    $('#expandedImg').attr('src', li_image_src);
	    $('#expandedImg').delay(200).fadeIn(100);
    });

    $('#parameters li').on('mouseout', function() {
      $('#expandedImg').fadeOut(100).attr('src',expandedImgSrc).delay(100).fadeIn(100);
    });
  }
...
/*=====================================
SERVICES USLUGI TABS
=====================================*/


function openUslugaTab(evt, cityName) {

      var i, tabcontent, tablinks;

      tabcontent = document.getElementsByClassName("tabcontent_usluga");


      //my string
      $(".tabcontent_usluga").slideToggle({duration: 400});
      //
      ...
      tablinks = document.getElementsByClassName("tablinks_usluga");
...
/*=====================================
SERVICES Techologia TABS
=====================================*/


function openTechologiaTab(evt, cityName) {

      var i, tabcontent, tablinks;

      tabcontent = document.getElementsByClassName("technolohia_tab_open");


      //my string
      $(".technolohia_tab_open").slideDown({duration: 400});
      //
      ...
      tablinks = document.getElementsByClassName("technologia_click_to_open");
      for (i = 0; i < tablinks.length; i++) {
        tablinks[i].className = tablinks[i].className.replace(" active", "");
      }
      document.getElementById(cityName).style.display = "block";
...
function openTechnoTab(evt, cityName, technoTabNumber) {
  var i, tabcontent, tablinks;
  

  tabcontent = document.getElementById(technoTabNumber).getElementsByClassName("tabcontent");
  tablinks = document.getElementById(technoTabNumber).getElementsByClassName("tablinks");
